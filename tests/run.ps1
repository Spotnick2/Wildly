<#
    ...
    Wildly loads LibGroupBuffs-1.0 first (the shared compat layer, engine and
    window), so the tests need it too. They read it from a checkout next to this repository -
